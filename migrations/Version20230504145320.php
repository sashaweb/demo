 ...
 */
final class Version20230504145320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE site CHANGE description description VARCHAR(4096) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE site CHANGE description description VARCHAR(80) NOT NULL');
    }
}
